...
const DoctorScheduleManagement = () => {
    ...
    const fetchSchedules = async () => {
        try {
            setLoading(true);
            const response = await axios.get('/admin/doctor-schedules');
    ...
    const handleUpdateSchedule = async () => {
        try {
            ...
            const scheduleData = {
                ...
                breakTime: {
                    start: formData.breakStartTime || null,
                    end: formData.breakEndTime || null
                },
            ...
            await axios.put(
                `/admin/doctor-schedules/${selectedSchedule._id}`,
                scheduleData
            );
    ...
    const handleAddSchedule = async () => {
        try {
            ...
            const response = await axios.post('/admin/doctor-schedules', scheduleData);
            toast({
                title: 'Success',
