...
const DoctorDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const appointmentsResponse = await axios.get('/appointments/doctor-appointments');
  ...
  const handleStatusChange = async (appointmentId, newStatus) => {
    try {
      setLoading(true);
      const response = await axios.patch(`/appointments/${appointmentId}/status`, { status: newStatus });
