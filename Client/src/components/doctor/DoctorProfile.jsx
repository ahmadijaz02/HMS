...
const DoctorProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const doctorResponse = await axios.get(`/doctors/${user.id}`);
      ...
      if (profileResponse.data.success && doctorResponse.data.success) {
        ...
        // Get schedule data
        try {
          const scheduleResponse = await axios.get(`/schedules/schedule/${user.id}`);
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const userProfileResponse = await axios.put('/users/profile', {
        name: profile.name,
        email: profile.email,
        phone: profile.phone,
      ...
      const doctorProfileResponse = await axios.put(`/doctors/${user.id}`, {
