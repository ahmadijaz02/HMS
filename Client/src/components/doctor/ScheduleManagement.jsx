...
const ScheduleManagement = () => {
  ...
  const fetchSchedule = async () => {
    ...
    try {
      ...
      const response = await axios.get(`/schedules/schedule/${user.id}`);
  ...
  const handleToggleDay = async (dayIndex) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `/schedules/schedule/${user.id}/${currentDay.day}`,
        updatedDaySchedule
      );
  ...
  const handleSaveSchedule = async () => {
    ...
    try {
      ...
      const response = await axios.put(`/schedules/schedule/${user.id}`, scheduleToSave);
  ...
  const handleSaveTimeSlots = async () => {
    ...
    try {
      ...
      const response = await axios.patch(
        `/schedules/schedule/${user.id}/${selectedDay.day}`,
        updatedDaySchedule
      );
